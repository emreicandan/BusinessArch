...
public class ClaimMenager : IClaimService
{
    private readonly IClaimRepository _claimRepository;
    private readonly ClaimValidations _claimValidations;

    public ClaimMenager(IClaimRepository claimRepository,ClaimValidations claimValidations)
    {
    ...
    {
        var claim = _claimRepository.Get(c => c.Id == id);
        await _claimValidations.IsClaimEmpty(claim);
